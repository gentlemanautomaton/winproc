...
func main() {
	var (
		...
		listIncludePIDs         = listCommand.Flag("pid", "include processes with a particular ID").Uint32List()
		...
		treeIncludePIDs         = treeCommand.Flag("pid", "include processes with a particular ID").Uint32List()
		...
		watchIncludePIDs        = watchCommand.Flag("pid", "include processes with a particular ID").Uint32List()
